...
<template>
    <div class="slide bg-white">
        ...
        <div class="absolute bottom-2 right-2  flex items-center gap-2 text-gray-400 opacity-40 hover:opacity-100 focus-within:opacity-100 duration-300">
            <button @click="prevSlide" :disabled="slideIndex === 0" class="p-2 disabled:opacity-30 cursor-pointer disabled:cursor-not-allowed rounded-full hover:bg-blue-200 duration-300 text-black">
                <HugeiconsIcon
            ...
            <button @click="nextSlide" :disabled="slideIndex >= totalSlides - 1" class="p-2 disabled:opacity-30 cursor-pointer disabled:cursor-not-allowed rounded-full hover:bg-blue-200 duration-300 text-black">
                <HugeiconsIcon
